...
public class TSBHashTableDA<K,V> implements Map<K,V>, Cloneable, Serializable {
    // Atributos Constantes, es el tamaño máximo que podrá tener el arreglo de soporte...
    ...
    // Atributos privados para gestionar vistas:
    ...
    // Devuelve la cantidad de elementos contenidos en la tabla
    @Override
    public int size() {
        return this.count;
    }
